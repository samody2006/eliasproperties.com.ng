...
<html lang="zxx">
<head>
    <title>Elias Properties | Home :: A Real Estate</title>
		...
		<div class="container py-md-4 mt-md-3">
			...
			<div class="card-deck mt-md-5 pt-5">
				  ...
				  <div class="card">
					...
					<div class="card-body w3ls-card">
					  <h5 class="card-title">Hot Offer!</h5>
					   <p class="card-text mb-3 ">You&#039;ll love this georgeous 4 Bedroom Duplex all ensuite + B/Q(One room) located right beside General Hospital, Ibeju.
				  ...
				  <div class="card">
					<img src="images/mowe1.jpeg" class="img-fluid" alt="Card image cap">
					<div class="card-body w3ls-card">
					  <h5 class="card-title">Perfect Home for You</h5>
    ...
    <div class="newsletter text-center py-lg-5">
        <div class="container py-5">
           ...
           <div class="newsletter-inner">
				<p class="text-light py-4">Get latest update on Hot offers and Promo. 
